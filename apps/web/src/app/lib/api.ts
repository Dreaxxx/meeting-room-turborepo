...
import type { Room, CreateRoomDto, Reservation, CreateReservationDto } from './types';
...
export const api = {
  ...
  reservations: {
    ...
    patch: (id: string, dto: Partial<CreateReservationDto>) =>
      data<Reservation>(http.patch(`/reservations/${id}`, dto)),
